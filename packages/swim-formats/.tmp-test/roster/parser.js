...
function isMeetEventsFile(content) {
...
function sniffRosterFormat(content) {
...
export function detectRosterFileFormat(filename, content) {
  if (content) {
...
export function parseRosterFile(content, format) {
  switch (format) {
    case "csv":
...
export function rosterImportErrorForFile(filename, content) {
